package sample.jxbsample.javacodegeeks.adapter;
...
import sample.jxbsample.javacodegeeks.beans.Country;

/**
 * Simple example of usage of jaxb marshaling functionalities when managing
 * complex classes, in this case java.time.LocalDate
 *
...
public class JaxBExampleAdapter {
    ...
    public static void main(String[] args) {
        try {
            ...
            jaxbMarshaller.marshal(country, new File("src/main/resources/jaxb/javacodegeeks/country_adapter.xml"));
