 ...
 */
package sample.jxbsample.javacodegeeks.beans;
...
import sample.jxbsample.javacodegeeks.adapter.DateAdapter;

/**
 * Country containing a name, a capital city, a foundation date and the
 * continent it belongs to, these attributes are going to be represented in this
 * order in the generated XML as described in the annotation XmlType
 *
